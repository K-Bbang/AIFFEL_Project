<<<<<<< HEAD
제목: 마크 저커버그가 직접 만들어 본 AI 비서 ‘자비스’
...
제목:  GPT-4 발표한 오픈AI '샘 알트만', "AI가 사회를 재구성할 것이며 위험을 인정합니다, 이것이 조금 두렵습니다"
...
제목: 세계 4대 AI 석학 앤드류 응 교수, "인공지능 업계에 영원한 봄 왔다"
...
-----
생각보다 어렵습니다ㅠㅠ 차근차근 해보면서도 헷갈리네요 ㅠㅠ
